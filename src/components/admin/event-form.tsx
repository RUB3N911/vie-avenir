  ...
  return (
    <form className="admin-form" action={action} encType="multipart/form-data">
      ...
      <section className="admin-form-card">
        ...
        <div className="admin-fields-grid">
          <label className="admin-field admin-field-wide"><span>Lien d’inscription externe</span><input name="registration_url" type="url" defaultValue={event?.registration_url ?? ""} placeholder="https://…" /><small>Laissez vide pour utiliser les inscriptions intégrées au site et les gérer depuis l’administration.</small></label>
